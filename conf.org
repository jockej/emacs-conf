...
#+BEGIN_SRC emacs-lisp
  (use-package yasnippet
    :config
    (setq yas-snippet-dirs '("~/.emacsconf/snippets"))
#+END_SRC
...
#+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
     (defun jj-turn-off-global-hl-line-mode ()
       (setq-local global-hl-line-mode nil))

     (global-hl-line-mode t)
     (make-variable-buffer-local 'global-hl-line-mode)
     (add-hook 'term-mode-hook 'jj-turn-off-global-hl-line-mode)
     (add-hook 'vterm-mode-hook 'jj-turn-off-global-hl-line-mode)
   #+END_SRC
