...
*** Initialize
    ...
    Unfortunately =Emacs= doesn't really work with proxies, which is a shame because
    I'd like to use it with =privoxy=, but well, not much to do.
...
*** The mighty gnus
    ...
    I use =gnus= to read mail. It is really awesome. At my work there is a big
    corporate firewall, so to read nntp I have to ssh tunnel via my home server.
    #+BEGIN_SRC emacs-lisp
      (require 'gnus)
...
=======
  ...
  (setq gnus-sync-backend (concat "/ssh:" jj-home-host-ssh-name
        ...
        gnus-sync-newsrc-groups '("nntp")
        gnus-sync-newsrc-offsets '(2 3))
>>>>>>> 763f18d96dbf47dcee22b995181aa230e85bdee2
      ...
      (advice-add 'gnus :after 'jj-maybe-read-sync)
...
<<<<<<< HEAD
    ...
    Store sent messages here, I'm not really sure of this one...
    #+BEGIN_SRC emacs-lisp
...
>>>>>>> 763f18d96dbf47dcee22b995181aa230e85bdee2
    ...
    Use the =w3m= browser by default. It's really good.
    #+BEGIN_SRC emacs-lisp
